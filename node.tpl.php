...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?>"<?php print $attributes; ?>>
  <header class="entry-header">
    ...
    <?php if (!$page): ?>
      <h2 class="entry-title"<?php print $title_attributes; ?>><a href="<?php print $node_url; ?>" rel="bookmark" title="<?php print $title; ?>"><?php print $title; ?></a></h2>
    <?php endif; ?>
  ...
  <div class="entry-content"<?php print $content_attributes; ?>>
    <?php
      ...
      hide($content['links']);
      // Edit this if you want to use another field for tags.
  ...
  <footer class="entry-footer">
    <span class="posted-on">
      ...
      <a href="<?php print $node_url; ?>" rel="bookmark">
        <time class="entry-date published" datetime="<?php print date_iso8601($created); ?>"><?php print format_date($created); ?></time>
...
<?php if ($page && isset($content['comments']['comments'])): ?>
